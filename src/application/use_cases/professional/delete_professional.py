...
class DeleteProfessionalAccount:
    ...
    def execute(self, professional_id: int) -> None:
        ...
        all_appointments = self.appointment_repository.list_by_professional(professional_id)
        
        for appointment in all_appointments:
            appointment.cancel()
            self.appointment_repository.save(appointment)
        
        all_availabilities = self.availability_repository.list_by_professional(professional_id)
