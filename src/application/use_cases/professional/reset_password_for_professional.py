...
class ResetPassword:
    def __init__(self, professional_repository: ProfessionalRepository, refresh_token_repository: RefreshTokenRepository, token_service: TokenService, password_hasher: PasswordHasher):
