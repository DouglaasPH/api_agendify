...
def deleteAccount(
    response: Response,
    current_professional: Professional = Depends(get_current_professional),
    use_case: DeleteProfessionalAccount = Depends(get_delete_professional_account_use_case),
):
...
def modify_data(
    ...
    current_professional: Professional = Depends(get_current_professional),
    use_case: UpdateProfessionalProfile = Depends(get_update_professional_profile_account_use_case),
):
