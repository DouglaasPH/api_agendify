...
def get_create_appointment_use_case(db=Depends(get_db)) -> CreateAppointment:
...
def get_cancel_appointment(db=Depends(get_db)) -> CancelAppointment:
...
def get_by_id_appointment(db=Depends(get_db)) -> GetByIdAppointment:
...
def get_list_appointment(db=Depends(get_db)) -> ListAppointments:
